...
class RegistrationPaymentMethodPickerBottomSheet : BottomSheetDialogFragment() {
    ...
    companion object {
        const val REQUEST_KEY = "registration_payment_method_picker_request"
        ...
        fun newInstance(availableTypes: List<String>): RegistrationPaymentMethodPickerBottomSheet {
            return RegistrationPaymentMethodPickerBottomSheet().apply {
